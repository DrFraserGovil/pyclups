...
COMPILE_OPTIONS =  -std=c++17 -pthread -O3 -w -march=native -Ilibs/Eigen/ -I/Users/jf20/Documents/JSL 
...
# Dependency options
DEPENDENCY_OPTIONS =  -MM -std=c++17 -Ilibs/Eigen/ -I/Users/jf20/Documents/JSL
