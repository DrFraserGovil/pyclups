...
constraint.Add(pyclups.constraint.Positive(lambda t: t == bottom)) ## only necessary to constrain the first point to be positive, monotonicity ensures all subsequent points are too!
...
pt.title("Positive \& Monotonic Constraint")
pt.legend()
pt.xlabel("$t$")
pt.ylabel("$z$")
